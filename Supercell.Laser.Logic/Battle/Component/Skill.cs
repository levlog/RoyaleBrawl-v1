namespace Supercell.Laser.Logic.Battle.Component
{
    ...
    public class Skill
    {
        ...
        public void Tick()
        {
            string v6 = SkillData.BehaviorType;
            bool result = SkillData.Targeted;
            bool v8 = result;
            if (result)
            {
                // uuh
        ...
        {
            bitStream.WritePositiveInt(TicksActive >= 0 && IsActive ? TicksActive+1 : 0, 11); // 0x15a048
            bitStream.WriteBoolean(false); // 0x15a05c
            bitStream.WritePositiveInt(0, 12); // 0x15a068
